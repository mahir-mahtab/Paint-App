...
function restoreCanvas() {
  for (let i = 1; i < drawnArray.length; i++) {
    ...
    console.log(drawnArray[i].erase);
...
downloadBtn.addEventListener('click', () => {
  downloadBtn.href = canvas.toDataURL('canva/jpeg',1);
...
// // // Event Listener
// {/* <input  class="jscolor" id="brush-color" value="a51dad"> */}
